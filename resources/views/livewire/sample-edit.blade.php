<div>
    <flux:modal name="edit-sample" class="md:w-96">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Edita la muestra</flux:heading>
            ...
            <div class="flex">
                ...
                <flux:button wire:click="update" type="submit" variant="primary">Actualizar muestra</flux:button>
